...
let pp = await this.profilePictureUrl(who, 'image').catch(_ => "https://qu.ax/QvCkQ.jpg")
...
global.canalIdGB = ["120363401930500362@newsletter"]
global.canalNombreGB = ["CANAL OFICIAL @ivessita_xn"]
...
global.img = 'https://qu.ax/QvCkQ.jpg'
...
global.gataVidMenu = ['https://qu.ax/QvCkQ.jpg', 'https://qu.ax/QvCkQ.jpg', 'https://qu.ax/QvCkQ.jpg'][Math.floor(Math.random() * 3)]
